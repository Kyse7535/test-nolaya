...
Le jalon produit « coiffeuse trouvée » est donc le dossier **READY** de l’étape 8.
...
| 7. Réponse et conciergerie | Quelle coiffeuse peut réellement poursuivre ? | Proposition professionnelle exploitable |
| 8. Accord et préparation | Sommes-nous d’accord sur la même chose ? | Coiffeuse trouvée et rendez-vous opérationnel |
...
Les numéros d’étapes sont une cartographie métier interne. L’interface cliente utilise quatre zones compréhensibles :
...
- [Étape 6 — Soumission de la demande](06-soumission-de-la-demande/user-stories.md)
- [Étape 7 — Réponse professionnelle et conciergerie](07-reponse-professionnelle-et-conciergerie/user-stories.md)
...
Prompts Stitch (`docs/prompts-stitch.md`) régénérés depuis user-flow + transitions + screen-specs (13 écrans).
